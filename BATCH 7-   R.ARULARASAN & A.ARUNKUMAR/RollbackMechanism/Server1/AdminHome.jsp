...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <%
                ...
                if (act != null) {
                    ...
                    String filepath = "/Rollback/Files/" + uname + "/" + accfilename + ".pdf";
                    //st.executeUpdate("insert into serverfiles1 values('" + uname + "','" + email + "'," + id + ",'" + caldate + "','" + fname + "','" + description + "','" + abfile + "','" + filepath + "','')");
                    Statement sts=con.createStatement();
                    sts.executeUpdate("update convertedfiles set filepath='" + filepath + "' where uname='" + uname + "' and email='" + email + "' and AbsFile='" + abfile + "'");
                    st.executeUpdate("update serverfiles1 set ch='1' where uname='" + uname + "' and email='" + email + "' and AbsFile='" + abfile + "'");
                }
                String act1 = request.getParameter("DelAction");
                if (act1 != null) {
                    String sid = request.getParameter("delid");
                    st.executeUpdate("delete from  serverfiles1 where id='" + sid + "'");
                }
    %>
        ...
        <div id="templatemo_container">
            ...
            <div id="templatemo_menu">
                <ul>
					...
					<li><a href="Rollback.jsp">Rollback</a></li>
            ...
            <form method="post" id="form1">
                <table width="847" border="0" align="center" bgcolor="#66CCFF">
                    ...
                    <%
                                int id = 0;
                                ResultSet rs = st.executeQuery("select * from serverfiles1");
                                while (rs.next()) {
                                    id += 1;
                    ...
                    %>
                    <script language="javascript">
                        alert("Alternative Server is Overloaded..Please Delete Completed Files");
                    </script>
                    <%                                }
                    %>
                </table>
