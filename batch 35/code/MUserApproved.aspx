<%@ Page Title="" Language="C#" MasterPageFile="~/Manager.master" AutoEventWireup="true" CodeFile="MUserApproved.aspx.cs" Inherits="MUserApproved" %>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label3" runat="server" style="font-weight: 700" 
                        Text="InActive  User Account"></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
                ...
                <td colspan="2">
                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkView0" runat="server" OnClick="lnkView_Click">InActive</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <FooterStyle BackColor="White" ForeColor="#000066" />
