<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="NewMangager.aspx.cs" Inherits="NewMangager" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td colspan="2">
                <strong>
                <asp:Label ID="Label1" runat="server" Text="New Manager Registration"></asp:Label>
                </strong>
            </td>
            <td>
                &nbsp;</td>
