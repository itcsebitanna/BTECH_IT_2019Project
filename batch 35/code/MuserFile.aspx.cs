...
public partial class MuserFile : System.Web.UI.Page
{
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand("select * from usertb where UserName='" + grdrow.Cells[3].Text + "' ", con);
    ...
    private void bind()
    {
        cmd = new SqlCommand("select * from userfiletb where Status='Wait For Key' and Mangername='" + Session["Manager"].ToString() + "'", con);
        ...
        cmd = new SqlCommand("select * from userfiletb where Status='Approved' and Mangername='" + Session["Manager"].ToString() + "' ", con);
