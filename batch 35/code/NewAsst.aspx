<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="NewAsst.aspx.cs" Inherits="NewAsst" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td colspan="2">
                <strong>
                <asp:Label ID="Label1" runat="server" Text="New Asst.Manager Registration"></asp:Label>
                </strong>
            </td>
            <td>
                &nbsp;</td>
        ...
        <tr>
            <td style="width: 255px">
                &nbsp;</td>
            <td style="width: 201px">
                <asp:Label ID="Label15" runat="server" Text="Manger"></asp:Label>
            </td>
            <td>
