...
<body>
<form name="Login" action="userlogin.jsp?va=1" method="post">
<div class=head>
<em style=font-weight:bold;font-size:20px;>PHR User Login</em>
...
<br>
  ...
  <div class="container" style="background-color:#f1f1f1">
    ...
    <a href="usersignup.jsp" class=cancelbtn>Signup</a>
                                        ...
                                        if (ent != null) {
                                           Statement smt = null;
                                            ...
                                            try {
                                                ...
                                                rs = smt.executeQuery("select * from users where username='" + UserName + "' and password='" + Password + "'");
                                                    
                                               out.println("Login successful.");  
                                              if (rs.next()) {
                                                        session.setAttribute("userlogid", rs.getString("user_id"));
