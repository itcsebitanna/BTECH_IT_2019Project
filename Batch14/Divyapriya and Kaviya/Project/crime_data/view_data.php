...
mysql_query("insert into upload(id,filename) values($id,'$fname')");	
...
<body>
 ...
 <div class="panel panel-default">
  <div class="panel-heading" align="center">DATA SET</div>
	...
	<div class="col-lg-8">
				...
				<thead>
				  <tr>
					...
					<th width="5%" class="bg-info">Data</th>
				...
				<?php
				$i=0;
				$qry=mysql_query("select * from upload");
				...
				?>
				  <tr>
					...
					<td class="bg-info2"><?php echo $row['filename']; ?></td>
					<th width="13%" class="bg-info2"><?php echo '<a href="view_data2.php?id='.$row['id'].'">View</a>'; ?></th>
