...
<body>
 ...
 <div class="panel panel-default">
  <div class="panel-heading" align="center">DATA - SEARCH </div>
	...
	<div class="col-lg-8">
				...
				<form name="name" method="post">
                  <div class="form-group">
                      <label>Source</label>
                      <input type="text" name="src1" placeholder="Source Place" class="form-control">
                    </div>
                    <div class="form-group">       
                      <label>Destination</label>
                      <input type="text" name="dest1" placeholder="Destination Place" class="form-control">
                    </div>
                    <div class="form-group">       
...
window.location.href="map.php?src1=<?php echo $src1; ?>&dest1=<?php echo $dest1; ?>";
</script>
<?php
}
else
