...
<body>
 ...
 <div class="panel panel-default">
  <div class="panel-heading" align="center">DATA (Feature Selection) </div>
...
<div class="row">
	...
	<div class="col-lg-8">
				...
				<iframe src="spreadsheet-reader-master/test4.php?File=upload/<?php echo $fname; ?>" width="800" height="500"></iframe>
				<form name="name" method="post">
                   
					
                    
                    <div class="form-group">       
                      <input type="submit" name="btn" value="Classification" class="btn btn-primary">
                    </div>
